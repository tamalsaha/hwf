...
import (
	...
	modulev1alpha1 "github.com/tamalsaha/hwf/apis/module/v1alpha1"
	modulecontrollers "github.com/tamalsaha/hwf/controllers/module"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "82471a98.x-helm.dev",
	})
	if err != nil {
